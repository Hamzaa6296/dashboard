...
export default function Profile() {
  ...
  if (!profile)
    return (
      <div
        style={{ textAlign: "center", paddingTop: 80, color: "var(--text-2)" }}
      >
        User not found
      </div>
    );
      ...
      >
        ...
        >
          ...
          <div style={{ padding: "0 28px 28px" }}>
            ...
            {error && (
              <div
                style={{ color: "var(--red)", fontSize: 13, marginBottom: 16 }}
              >
                {error}
              </div>
            )}
              ...
              <div>
                ...
                {editing ? (
                  ...
                  <span
                    style={{
                      fontSize: 15,
                      color: form.bio ? "var(--text)" : "var(--text-3)",
                    }}
                  >
                    {form.bio || "No bio set"}
                  </span>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >
            ...
            >
              ...
              <h3 style={{ fontFamily: "Syne", fontSize: 15, fontWeight: 600 }}>
                Recent Projects
              </h3>
            </div>
            {projects.length === 0 ? (
                    ...
                    >
                      ...
                      <div
                        style={{
                          ...
                          borderRadius: "50%",
                          background:
                            STATUS_COLORS[p.status] || "var(--text-3)",
                          flexShrink: 0,
                          marginLeft: 8,
                        }}
                      />
              ...
              >
                ...
                <button
                  ...
                  style={{
                    background: "none",
                    border: "none",
                    color: showPwForm ? "var(--text-3)" : "var(--accent)",
                    fontSize: 13,
                    cursor: "pointer",
                  }}
                >
