...
const features = [
  {
    ...
    desc: "Live metrics and activity tracking across all your projects.",
  },
  {
    icon: FolderKanban,
    title: "Project Management",
    desc: "Create, organize, and track projects with priority and status management.",
  },
  {
    icon: Users,
    title: "Team Collaboration",
    desc: "Manage team members and their contributions in one place.",
  },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Novu gives your team a unified workspace to manage projects, track
          progress, and stay in sync — all in real time.
        </p>
          ...
          <Link
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow =
                "0 8px 24px rgba(124,106,247,0.35)";
            }}
            onMouseLeave={(e) => {
      ...
      {/* Features */}
      <section
        style={{ padding: "40px 48px 100px", maxWidth: 1100, margin: "0 auto" }}
      >
        <h2
          style={{
            fontFamily: "Syne",
